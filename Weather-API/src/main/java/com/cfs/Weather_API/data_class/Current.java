package com.cfs.Weather_API.data_class;
...
public class Current{
    ...
    public Current(int last_updated_epoch, String last_updated, double temp_c, double temp_f, int is_day, Condition condition, int wind_mph, double wind_kph, int wind_degree, String wind_dir, int pressure_mb, double pressure_in, int precip_mm, int precip_in, int humidity, int cloud, double feelslike_c, double feelslike_f, double windchill_c, double windchill_f, double heatindex_c, double heatindex_f, double dewpoint_c, double dewpoint_f, int vis_km, int vis_miles, double uv, int gust_mph, double gust_kph, int will_it_rain, int chance_of_rain, int will_it_snow, int chance_of_snow, double short_rad, double diff_rad, double dni, double gti) {
